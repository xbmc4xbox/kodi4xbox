...
void CGraphicContext::OnSettingChanged(const std::shared_ptr<const CSetting>& setting)
{
  if (setting == NULL)
    return;
...
{
  g_Windowing.SetCameraPosition(camera, m_iScreenWidth, m_iScreenHeight, 0.0f);
}
